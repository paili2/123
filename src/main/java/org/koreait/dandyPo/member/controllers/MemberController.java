...
import org.koreait.dandyPo.member.services.MemberUpdateService;
import org.koreait.dandyPo.member.validators.JoinValidator;
...
public class MemberController {
    ...
    private void commonProcess(String mode, Model model) {
        ...
        List<String> addScript = new ArrayList<>(); // front 쪽에 추가하는 자바스크립트
